    ...
    <footer className="border-t border-white/5 py-12 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            <h4 className="font-semibold mb-3 text-foreground/80">Account</h4>
            <div className="flex flex-col gap-2 text-sm text-foreground">
          ...
          <div>
            <h4 className="font-semibold mb-3 text-foreground/80">Support</h4>
            <div className="flex flex-col gap-2 text-sm text-foreground">
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-foreground/30">
