            ...
            <tbody>
              {orders.map(o=>(
                <tr key={o.id} className="border-t border-white/[0.03] hover:bg-white/[0.02]">
                  <td className="px-4 py-3 text-white/30 font-mono">#{o.id.slice(-6)}</td>
                  <td className="px-4 py-3 text-white/60 max-w-[120px] truncate">{o.user.email}</td>
                  <td className="px-4 py-3 text-white/80 max-w-[160px] truncate">{o.service.name}</td>
                  <td className="px-4 py-3 text-white/40 max-w-[100px] truncate">{o.link}</td>
                  ...
                  <td className="px-4 py-3"><span className={`px-2 py-0.5 rounded-full ${STATUS_COLORS[o.status]||"text-white/40 bg-white/5"}`}>{o.status}</span></td>
